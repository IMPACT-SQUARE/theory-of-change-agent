...
CSR·ESG 프로젝트면 변화이론 도식을 만들어 줍니다. 어느 쪽이든 뒤에서 돌아가는 논리는 같고, 마지막에 보여
주는 결과물의 모양만 다릅니다. (임팩트 투자심사용 '투심 모드'는 이후 개발 예정입니다.)
...
- **표를 먼저 만들고 그 위에서 고치기** — 가장 빠릅니다. (약 2–5분) 일단 초안 표를 만들어 주고, 마음에 안 드는 칸을 고쳐 나간 뒤 "확정"하면 품질 점검을 거쳐 마무리합니다.
